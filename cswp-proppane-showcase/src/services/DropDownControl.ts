...
export class DropDownControl {
  ...
  private options: IPropertyPaneDropdownOption[] = <IPropertyPaneDropdownOption[]>[
    {
      index: 0,
      key: 'red',
      text: 'red'
      ...
      groups: [
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneDropdown('dropDown_dummyProperty0', <IPropertyPaneDropdownProps>{
        ...
        },
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneDropdown('dropDown_dummyProperty1', <IPropertyPaneDropdownProps>{
              label: 'Dropdown Label',
              options: this.options,
              selectedKey: 'green'
            })
