import {
  ...
  PropertyPaneCheckbox, IPropertyPaneCheckboxProps
      ...
      groups: [
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneCheckbox('checkbox_dummyProperty0', <IPropertyPaneCheckboxProps>{
              text: 'Checkbox label'
            })
          ]
        },
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneCheckbox('checkbox_dummyProperty1', <IPropertyPaneCheckboxProps>{
              text: 'Checkbox label',
              checked: true
            })
          ]
        },
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneCheckbox('checkbox_dummyProperty2', <IPropertyPaneCheckboxProps>{
              text: 'Checkbox label',
              disabled: true
            })
          ]
