import {
  ...
  PropertyPaneChoiceGroup, IPropertyPaneChoiceGroupProps,
...
export class ChoiceGroupControl {
  ...
  private options: IPropertyPaneChoiceGroupOption[] = <IPropertyPaneChoiceGroupOption[]>[
    {
      key: 'red',
      text: 'red'
    },
  ...
  private imgOptions: IPropertyPaneChoiceGroupOption[] = <IPropertyPaneChoiceGroupOption[]>[
    {
      key: 'xlsx',
      text: 'xlsx',
      imageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/xlsx_32x2.png',
      selectedImageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/xlsx_32x2.png',
      imageSize: {
        width: 64,
        height: 64
      }
    },
    {
      key: 'docx',
      text: 'docx',
      imageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/docx_32x2.png',
      selectedImageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/docx_32x2.png',
      imageSize: {
        width: 64,
        height: 64
      }
    },
    {
      key: 'one',
      text: 'one',
      imageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/one_32x2.png',
      selectedImageSrc: 'https://static2.sharepointonline.com/files/fabric/assets/brand-icons/document/png/one_32x2.png',
      imageSize: {
        width: 64,
        height: 64
      }
      ...
      groups: [
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneChoiceGroup('choiceGroup_dummyProperty0', <IPropertyPaneChoiceGroupProps>{
        ...
        },
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneChoiceGroup('choiceGroup_dummyProperty1', <IPropertyPaneChoiceGroupProps>{
              label: 'Choice Group label',
        ...
        },
        {
          ...
          groupFields: [
            ...
            PropertyPaneHorizontalRule(),
            PropertyPaneChoiceGroup('choiceGroup_dummyProperty2', <IPropertyPaneChoiceGroupProps>{
              label: 'Choice Group label',
